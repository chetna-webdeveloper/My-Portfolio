    ...
    <footer className="bg-black text-white p-10 relative">
      <div className="container mx-auto  md:grid-cols-3 grid-cols-1 grid lg:grid-cols-3 lg:justify-items-center items-start">
        ...
        <div className="mb-6 md:mb-0 right-0">
          ...
          <a href="https://www.linkedin.com/in/chetna-chetna-595308326/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-400 flex items-center m-1">
      ...
      <div className="text-center mt-6">
        <p className="text-gray-400 text-sm">© {new Date().getFullYear()} Chetna. All rights reserved.</p>
      </div>
